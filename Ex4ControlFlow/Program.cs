...
namespace Ex4ControlFlow
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //  Incrementor: when car speed is 5 km/ hour or beyound
            int demeritDelta = 0;

            //  Programs Entry & Exit Bool
            bool demerit = true;
            ...
            do
            {
                ...
                //  License Supension Checker and Exit when requirement are met
                bool suspensionCheck = true;
